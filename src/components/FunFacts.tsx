const FunFacts = () => {
    // TODO: add carousel animation

    return (
        <div className="w-full h-full flex items-center">
            <div className="flex gap-6 sm:gap-12 md:gap-6 flex-col sm:flex-row lg:flex-col sm:justify-between w-full xl:flex-col 3xl:justify-between h-full items-start px-3">
                ...
                {/* <div className="sm:h-auto sm:w-1/3 md:w-72 md:h-72 w-80 h-80 lg:h-56 lg:w-56 xl:w-72 xl:h-72 3xl:w-96 3xl:h-96">
                    <div className="w-full mx-2 bg-white rounded-lg shadow-md shadow-indigo-900/5">
                        <a
                            target="_blank"
                            rel="noreferrer"
                            href="https://instagram.com/_karan.garg"
                        >
                            <div
                                className="relative overflow-hidden rounded-lg aspect-square h-full w-full"
                                role="region"
